    ...
    addUserToActiveRoom: function addUserToActiveRoom() {
      ...
      fetch("http://azurix.pl:8080/room/" + this.activeRoom.id + "/add?login=" + this.addUser.login, {
        ...
        if (res.status === 200) {
          ...
          _this3.addUser.login = ""; // Synchronize users

          _this3.getActiveRoomUsers();
        } else {
          ...
          _c("div", { staticClass: "header" }, [
            ...
            _c("p", { attrs: { id: "active-room-users" } }, [
              _c(
                "span",
                { attrs: { id: "roomUsers" } },
                _vm._l(_vm.activeRoom.users, function(user, index) {
                  return _c(
                    "span",
                    {
                      key: index,
              ...
              _c(
                ...
                [
                  _c("i", {
                    ...
                    on: {
                      click: function($event) {
                        _vm.addUser.visible = !_vm.addUser.visible
                      }
                    }
                  })
                ]
                ...
                directives: [
                  {
                    name: "show",
                    rawName: "v-show",
                    value: _vm.addUser.visible,
                    expression: "addUser.visible"
                  }
                ],
                staticClass: "add-form form-group mt-2",
                    ...
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.addUser.login,
                        expression: "addUser.login"
                      }
                    ],
                    staticClass: "form-control m-0",
                    attrs: { type: "text", placeholder: "User login" },
                    domProps: { value: _vm.addUser.login },
                    on: {
                      keydown: function($event) {
                        if (
                          !("button" in $event) &&
                        ...
                        _vm.addUserToActiveRoom()
                      },
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.$set(_vm.addUser, "login", $event.target.value)
                      }
                    }
                  }),
                  _vm._v(" "),
...
var render = function() {
  ...
  return _c("div", { staticClass: "register" }, [
    _c("div", { attrs: { id: "auth-box" } }, [
      _c("div", { staticClass: "auth-form" }, [
        _c("h1", { staticClass: "mb-0" }, [_vm._v("Register")]),
        _vm._v(" "),
...
*/
window.Vue = __webpack_require__(/*! vue */ "./node_modules/vue/dist/vue.common.js"); // Auth components

Vue.component('login', __webpack_require__(/*! ./components/auth/Login.vue */ "./resources/js/components/auth/Login.vue").default);
Vue.component('register', __webpack_require__(/*! ./components/auth/Register.vue */ "./resources/js/components/auth/Register.vue").default); // Chat VUE
...
module.exports = __webpack_require__(/*! D:\xampp_new\htdocs\Chat-Web\resources\js\frontend.js */"./resources/js/frontend.js");
